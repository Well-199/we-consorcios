...
<body>
    ...
    <nav class="menuTopo" id="topImovel">
    ...
    <section class="containerMain">
        ...
        <div class="bannerImovel">
            <div class="bannerImovelContent">
                <div class="bannerImovelText">
                    ...
                    <h1>Melhores Consórcios de Imóvel</h1><br>
                    <p>#TMJ para realizar o seu sonho de <br/>forma justa e segura.</p>
                </div>
                <div class="bannerImovelImage" onClick="getBannerImovel()">
                    <a href="formulario.php">
                        <img src="../Images/We-Consorcios-Banner-Imovel-460x198.png" class="img"/>
                    </a>
                </div>
            </div>   
        </div>

        <div class="topoPages" onClick="getBannerImovel()"><a href="formulario.php"><img src="../Images/We-Consorcios-Banner-750x950-imoveis-bg.png" class="img"/></a></div>

        <div class="bannerAnuncios" style="height: 333px">
            <div class="div1" onClick="getImovel1()"><a href="formulario.php"><img class="img" src="../Images/We-Consorcios-Banner-Imovel-291x287.png"/></a></div>
            <div class="div2" onClick="getImovel2()"><a href="formulario.php"><img class="img" src="../Images/We-Consorcios-Banner-Imovel-291x287-02.png"/></a></div>
            <div class="div2" onClick="getImovel3()"><a href="formulario.php"><img class="img" src="../Images/We-Consorcios-Banner-Imovel-291x287-03 (1).png"/></a></div>
        </div>
        <div class="bannerReguaImovel">
            ...
            <div class="sectionBannerAnuncios">
                ...
                <div>
                    <div class="banners">
                        <div class="bannersPagesAnimation1"><a href="veiculo.php"><img class="img" src="../Images/We-Consorcios-Banner-Veiculo-460x198.png"/></a></div>
                        <div class="bannersPagesAnimation2"><a href="#topImovel"><img class="img" src="../Images/We-Consorcios-Banner-Imovel-460x198.png"/></a></div>
