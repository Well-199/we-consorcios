...
<body>
    ...
    <section class="containerMain">
        <div class="topo">
            <div></div>
            <h1>Consórcio de Automóvel</h1>
        </div>
        <div class="bannerImovel">
            <div class="bannerImovelContent">
                <div class="bannerImovelText">
                    <h2>Você merece os</h2>
                    <h1>Melhores Consórcios de Automóvel</h1><br>
                    <p>#TMJ para realizar o seu sonho de <br/>forma justa e segura.</p>
                </div>
                <div class="bannerImovelImage" onClick="getBannerVeiculo()">
                    <a href="formulario.php">
                        <img src="../Images/We-Consorcios-Banner-Veiculo-460x198.png" class="img"/>
                    </a>
                </div>
            </div>   
        </div>

        <div class="topoPages" onClick="getBannerVeiculo()"><a href="formulario.php"><img src="../Images/We-Consorcios-Banner-750x950-automovel-bg.png" class="img"/></a></div>
        
        <div class="bannerAnuncios">
            <div class="div1" onClick="getVeiculo1()"><a href="formulario.php"><img class="img" src="../Images/We-Consorcios-Banner-Veiculo-291x287-02.jpg"/></a></div>
            <div class="div2" onClick="getVeiculo2()"><a href="formulario.php"><img class="img" src="../Images/We-Consorcios-Banner-Veiculo-291x287.png"/></a></div>
            <div class="div2" onClick="getVeiculo3()"><a href="formulario.php"><img class="img" src="../Images/We-Consorcios-Banner-Veiculo-291x287-03.png"/></a></div>
            
            <!-- Inicio Alteraçao em 15/09/2021 -->
            <div class="div1" onClick="getVeiculo1()"><a href="formulario.php"><img class="img" src="../Images/GM.jpg"/></a></div>
            <div class="div2" onClick="getVeiculo2()"><a href="formulario.php"><img class="img" src="../Images/Valor.jpg"/></a></div>
            <div class="div2" onClick="getVeiculo3()"><a href="formulario.php"><img class="img" src="../Images/Yamaha.jpg"/></a></div>
            <!-- Fim Alteraçao em 15/09/2021 -->
        </div>
        <div class="bannerReguaImovel">
            <img src="../Images/Banner-regua.jpg" class="img" id="imgPagesRegua"/>

            <div class="sectionBannerAnuncios">
                <div class="imageConsorcios">
                    <img class="imgCasa" src="../Images/bannerCasa.png"/>
                </div>
                <div>
                    <div class="banners">
                        <div class="bannersPagesAnimation1"><a href="#topVeiculo"><img class="img" src="../Images/We-Consorcios-Banner-Veiculo-460x198.png"/></a></div>
                        <div class="bannersPagesAnimation2"><a href="imovel.php"><img class="img" src="../Images/We-Consorcios-Banner-Imovel-460x198.png"/></a></div>
                        <div class="bannersPagesAnimation3"><a href="moto.php"><img class="img" src="../Images/We-Consorcios-Banner-Moto-460x198.png"/></a></div>
                    </div>    
                </div>
            </div>
            ...
            <img src="../Images/We-Consorcios-Banner-750x950-linha-do-temp.png" class="imgMobiliePages"/>
              
            <div class="bannerSection" id="bannerSectionImg">

                <div class="bannerSectionImg" >
                    <img src="../Images/We-Consorcios-Banner-veiculo-1100x400-Caminho-bgs.png" class="img" alt="BANNER"/>
                </div>
            </div>
            ...
            <div class="footerLogos">
                <div class="footerText">
                    <h1>As Melhores Administradoras de Consórcio do Brasil</h1>
                </div>
                <div class="logos">
                    <div class="yamaha">
                        <img src="../Images/rci-v2.png" class="img"/>
                    </div>
                    <div class="renault">
                        <img src="../Images/yamaha-v2.png" class="img"/>
                    </div>
                    <div class="embracon">
                        <img src="../Images/embracon-v2.png" class="img"/>
                    </div>
                    <div class="volkswagem">
                        <img src="../Images/vw-v2.png" class="img"/>
                    </div>
                    <div class="bbconsorcios">
                        <img src="../Images/bb-v2.png" class="img"/>
                    </div>
                    <!-- inicio Alteracoes 12/09/2021 -->
                    <div class="renault">
                        <img src="../Images/GM-186x41.png" class="img"/>
                    </div>

                    <div class="bbconsorcios">
                        <img src="../Images/home-Valor.png" class="img"/>
                    </div>
                    <!-- Fim Alteracoes 12/09/2021 -->
                </div>
            </div>
            <div class="footerForm">
                <div class="footerFormText" id="footerFormText">
                    <div>
                ...
                <div class="footerFormContent" id="formulario">
