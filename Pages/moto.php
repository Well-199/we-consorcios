...
<body>
    ...
    <section class="containerMain">
        <div class="topo">
            <div></div>
            <h1>Consórcio de Moto</h1>
        </div>
        <div class="bannerImovel">
            <div class="bannerImovelContent">
                <div class="bannerImovelText">
                    <h2>Você merece os</h2>
                    <h1>Melhores Consórcios de Motos</h1><br>
                    <p>#TMJ para realizar o seu sonho de <br/>forma justa e segura.</p>
                </div>
                <div class="bannerImovelImage" onClick="getBannerMoto()">
                    <a href="formulario.php">
                        <img src="../Images/We-Consorcios-Banner-Moto-460x198.png" class="img"/>
                    </a>
                </div>
            </div>   
        </div>

        <div class="topoPages" onClick="getBannerMoto()"><a href="formulario.php"><img src="../Images/We-Consorcios-Banner-750x950-moto-bg.png" class="img"/></a></div>
        
        <div class="bannerAnuncios" style="height: 333px">
            <div class="div1" onClick="getMoto1()"><a href="formulario.php"><img class="img" src="../Images/We-Consorcios-Banner-Moto-291x287-02.png"/></a></div>
            <div class="div2" onClick="getMoto2()"><a href="formulario.php"><img class="img" src="../Images/We-Consorcios-Banner-Moto-291x287.png"/></a></div>
            <div class="div2" onClick="getMoto3()"><a href="formulario.php"><img class="img" src="../Images/We-Consorcios-Banner-Moto-291x287-03.png"/></a></div>
        </div>
            ...
            <div class="sectionBannerAnuncios">
                ...
                <div>
                    <div class="banners">
                        ...
                        <div class="bannersPagesAnimation3"><a href="#topMoto"><img class="img" src="../Images/We-Consorcios-Banner-Moto-460x198.png"/></a></div>
                    </div>    
                </div>
            </div>
