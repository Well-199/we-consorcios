...
fbq('init', '388264225554878');
fbq('track', 'PageView');
</script>
<noscript><img height="1" width="1" style="display:none"
src="https://www.facebook.com/tr?id=388264225554878&ev=PageView&noscript=1"
/></noscript>
    ...
    <link rel="stylesheet" type="text/css" href="./Style/imovel.css"/>
...
<body>
    ...
    <nav class="menuTopo">
        ...
        <div class="containerMenu" id="containerMenu">
            <div class="divLogo" id="divLogo">
                <img src="./Images/we-logo-horizontal_RGB-cinza.png" id="logoWE" alt="WE Consórcios" class="img"/>
            </div>
            ...
            <div id="menuMobile" onclick="closeMenu()">
                <ul>
                    <li><a href="Pages/veiculo.php">Automóvel</a></li>
                    <li><a href="Pages/imovel.php">Imóvel</a></li>
                    <li><a href="Pages/moto.php">Moto</a></li>
                    <li><a href="Pages/quemSomos.php">Quem somos</a></li>
                    <li><a href="Pages/contato.php">Contato</a></li>
                    <li><a href="Pages/formulario.php">Simular Consórcio</a></li>
                </ul>
            </div>
            ...
            <div class="menuOption">
                <ul class="menuUl">
                    ...
                    <li class="buttonSimular"><a href="Pages/formulario.php">Simular Consórcio</a></li>
                </ul>
            </div>
        </div>   
    </nav>
    ...
    <section class="containerMain">
        ...
        <div class="containerImg">
            <img src="./Images/We-Recorte-Modelo-2.png" class="img"/>
        </div>
        
        <div class="subContainer1">
            <div class="containerText">
                <h2>Você merece os</h2>
                <h1>Melhores Consórcios</h1>
                <p>
                    Realize os seus sonhos de forma simples e segura
                    no Maior <span>Marketplace de Consórcios do Brasil!</span>
                </p>
            </div>

            <div class="containerImgTopoMobile">
                <img src="./Images/We-Consorcios-Banner-750x950-Mobile.png" class="img"/>
            </div>

            <div class="containerAnuncios">
                <div class="banner1">
                    <a href="Pages/veiculo.php">
                        <img src="./Images/We-Consorcios-Banner-veiculo-291x188.png" class="img"/>
                    </a>
                </div>
                <div class="banner2">
                    <a href="Pages/imovel.php">
                        <img src="./Images/We-Consorcios-Banner-Imovel-291x188.png" class="img"/>
                    </a>
                </div>
                <div class="banner3">
                    <a href="Pages/moto.php">
                        <img src="./Images/We-Consorcios-Banner-moto-291x188.png" class="img"/>
                    </a>
                </div>
            </div>
            ...
            <div class="bannerSectionMobile" id="bannerSectionMobile">
                <img src="./Images/We-Consorcios-Banner-750x950-linha-do-temp.png" class="img"/>
            </div>

        <div class="bannerRegua">
            <img src="./Images/Banner-regua.jpg" class="img"/>
        </div>
                ...
                <div class="endFooterContent">
                    ...
                    <div class="text2">
                        ...
                        <ul>
                            ...
                            <li><a href="./Pages/perguntasFrequentes.php">Perguntas Frequentes</a></li>
                            <li><a href="./Pages/contato.php">Contato</a></li>
                            <li><a href="./Pages/trabalheConosco.php">Trabalhe conosco</a></li>
...
<i style="margin-top:16px" class="fa fa-whatsapp"></i>
    ...
    <section id="cookies" class="animate__animated animate__fadeInUp" style="display: none;">
        ...
        Para proteger seus dados pessoas respeitamos nossa <a href="./Pages/politica-privacidade.php" style="color: #4ce0c9;"> Política de Privacidade. </a> 
